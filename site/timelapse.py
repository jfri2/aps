...
class Timelapse:
    ...
    def save_frame(self, frame):
        ...
        if (int(current_time.hour) < 23) and ((int(current_time.hour) >= 5)) or override:
            ...
            filename = self.TIMELAPSE_IMAGE_PATH + "{:010d}".format(image_number) + ".jpg"
    ...
    def _order_frames(self):
        ...
        for filename in missing_files:
            new_filename = self.TIMELAPSE_IMAGE_PATH + "{:010d}".format(filename) + ".jpg"
            filename_to_copy = self.TIMELAPSE_IMAGE_PATH + "{:010d}".format(filename + 1) + ".jpg"
    ...
    def _generate_timelapse(self, debug_print=True):
        ...
        while (True):
            ...
            if self.timelapse_generation_in_process == False:
                ...
                old_timelapse_video_full_path = self.TIMELAPSE_VIDEO_PATH + old_timelapse_video_filename
